...
/* 	printf("LIGHT\n");
	...
	while (rt->n_checkerboards > i)
	{
		...
		printf("%-11s %i\n%-11s %i,%i,%i\n%-11s %i,%i,%i\n%-11s %.2f\n", \
				...
				"RGB1:", rt->checkerboards[i]->rgb1[0], rt->checkerboards[i]->rgb1[1], rt->checkerboards[i]->rgb1[2], \
				"RGB2:", rt->checkerboards[i]->rgb2[0], rt->checkerboards[i]->rgb2[1], rt->checkerboards[i]->rgb2[2], \
